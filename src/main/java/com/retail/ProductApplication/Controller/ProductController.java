package com.retail.ProductApplication.Controller;
...
import com.retail.ProductApplication.Service.ProductService;
...
public class ProductController {
	...
	public ResponseEntity<?> listproducts(){
		...
		try {
		    ...
		    return new ResponseEntity<>("can list Products"+" "+e.toString(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> createProduct(@RequestBody Product product) {
		if(product.getPrice()>10000) {
			return new ResponseEntity<>("Price is not allowed more than 10000 pls give  different rates or create another product", HttpStatus.BAD_REQUEST);
		}
